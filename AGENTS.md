...
- Keep `tools\hostessctl\companion_operator_actions.py` as the read-only
  ...
  that WPF advertises; it must not execute commands, select latest artifacts,
