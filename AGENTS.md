...
- Keep `tools\hostessctl\companion_transport_gates.py` as the read-only
  ...
  optionally fail automation on pending gates; it must not run probes, select
  artifacts, change firewall/device state, parse media, or promote evidence.
