...
pub use camera::{
    ...
    VisualProjectionState, HOSTESS_CAMERA_SOURCE_DIAGNOSTICS_SCHEMA,
    HOSTESS_CAMERA_TEXTURE_LANE_CONTRACT_SCHEMA, HOSTESS_SOURCE_SAMPLING_CONTRACT_SCHEMA,
...
pub use home::{
    ...
    SettingsShortcutCategory, SettingsShortcutDescriptor, HOSTESS_HOME_FOCUS_RECOVERY_EVENT_SCHEMA,
    HOSTESS_HOME_LAUNCHER_ENTRY_SCHEMA, HOSTESS_HOME_PANEL_DESCRIPTOR_SCHEMA,
    HOSTESS_HOME_SESSION_STATE_SCHEMA, HOSTESS_HOME_SETTINGS_SHORTCUT_SCHEMA,
    HOSTESS_KIOSK_COMMAND_EVIDENCE_SCHEMA, HOSTESS_KIOSK_COMMAND_RUN_RECORD_SCHEMA,
    HOSTESS_KIOSK_CONTROL_PLANE_STATUS_SCHEMA, LEGACY_RUSTY_XR_HOME_FOCUS_RECOVERY_EVENT_SCHEMA,
    LEGACY_RUSTY_XR_HOME_LAUNCHER_ENTRY_SCHEMA, LEGACY_RUSTY_XR_HOME_PANEL_DESCRIPTOR_SCHEMA,
    LEGACY_RUSTY_XR_HOME_SESSION_STATE_SCHEMA, LEGACY_RUSTY_XR_HOME_SETTINGS_SHORTCUT_SCHEMA,
    LEGACY_RUSTY_XR_KIOSK_COMMAND_EVIDENCE_SCHEMA, LEGACY_RUSTY_XR_KIOSK_COMMAND_RUN_RECORD_SCHEMA,
