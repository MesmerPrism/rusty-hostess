...
public static class OperatorActionCatalog
{
    ...
    private const string ProtocolMatrixCliRoute =
        ...
        "python $HostessCtl connectivity-probe wifi-direct-lifecycle-plan --probe-id QCL-040 --out $Qcl040LifecyclePlan --preflight-report-out $Qcl040Preflight --adb $Adb --serial $QuestSerial; " +
        "python $HostessCtl connectivity-probe wifi-direct-lifecycle-plan --probe-id QCL-041 --out $Qcl041LifecyclePlan --preflight-report-out $Qcl041Preflight --adb $Adb --serial $QuestSerial; " +
        ...
        "python $HostessCtl companion-report projection --protocol-matrix $ProtocolMatrix --include-protocol-matrix-inputs --suite-run $SuiteRun --firewall-rule $FirewallVerify --direct-wifi-product-media-plan $DirectWifiProductMediaPlan --out $Projection; " +
