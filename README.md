...
- `tools/studio_staging/request_cli.py`: Studio staging request command
  orchestration. It wires intake, smoke, PMB, handoff, downstream shell, and
  validation outputs without owning the schema helpers.
