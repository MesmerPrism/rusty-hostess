...
from tools.makepad_quest_gpu_evidence.force_authority import (
    analyze_force_authority_evidence,
)
from tools.makepad_quest_gpu_evidence.proof_lines import (
...
class EvidenceThresholds:
    ...
    require_gpu_force_runtime_authority: bool = False
...
def validate_summary(
    ...
    force_authority = analyze_force_authority_evidence(
        proof_lines=proof_lines,
        thresholds=thresholds,
        field_particle_force_lines=field_particle_force_lines,
        field_particle_force_max_sample_count=field_particle_force_max_sample_count,
        expanded_force_oracle_sample_count=EXPANDED_FORCE_ORACLE_SAMPLE_COUNT,
    )
    issues.extend(force_authority.issues)
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--require-gpu-force-runtime-authority",
        action="store_true",
        help=(
            "Require a promoted runtime GPU dense-SDF particle-force authority "
            "marker after steady residency, freshness, cadence, expanded oracle, "
            "and live/recorded provider A/B gates pass."
        ),
    )
    parser.add_argument(
...
def main(argv: list[str] | None = None) -> int:
    ...
    thresholds = EvidenceThresholds(
        ...
        require_gpu_force_runtime_authority=args.require_gpu_force_runtime_authority,
