...
def probe_args_for_slot(
    ...
    *,
    ...
    return argparse.Namespace(
        ...
        websocket_source=getattr(args, "websocket_source", "host-loopback"),
        websocket_bind_host=getattr(args, "websocket_bind_host", "127.0.0.1"),
        websocket_port=int(getattr(args, "websocket_port", 0) or 0),
        websocket_path=getattr(args, "websocket_path", "/qcl079"),
        websocket_message_count=int(getattr(args, "websocket_message_count", 16) or 16),
        websocket_payload_bytes=int(getattr(args, "websocket_payload_bytes", 96) or 96),
        websocket_timeout_seconds=float(getattr(args, "websocket_timeout_seconds", 5.0) or 5.0),
        websocket_route_descriptor=getattr(args, "websocket_route_descriptor", ""),
        websocket_route_evidence=getattr(args, "websocket_route_evidence", ""),
