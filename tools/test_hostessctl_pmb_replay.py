...
def ready_pmb_live_route_report() -> dict[str, object]:
    return {
        ...
        "state_samples": [
            {"sequence_id": 1, "stream_id": "stream.breath.state", "state": "pause", "state01": 0.5},
            {"sequence_id": 2, "stream_id": "stream.breath.state", "state": "inhale", "state01": 1.0},
        ],
        "state_value_samples": [
            {
                "sequence_id": 1,
...
def ready_pmb_quest_simulated_live_evidence(package: dict[str, object]) -> dict[str, object]:
    return {
        ...
        "execution": {
            ...
            "breath_state_published_to_broker": True,
            "breath_state_value_published_to_broker": True,
        ...
        "route_report_summary": {
            ...
            "normalized_stream_ids": ["stream.motion.vector3", "stream.motion.object_pose"],
                ...
                "state_sample_count": 6,
                "state_value_sample_count": 6,
        ...
        "broker_publish_summary": {
            ...
            "state_published_count": 6,
            "state_value_published_count": 6,
...
def write_projected_motion_package_tree(packages_root: Path) -> None:
    ...
    for filename, stream_id in [
        ...
        ("breath-state.json", "stream.breath.state"),
        ("breath-state-value.json", "stream.breath.state.value"),
