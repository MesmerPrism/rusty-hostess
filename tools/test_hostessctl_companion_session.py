...
class HostessCtlCompanionSessionTests(unittest.TestCase):
    ...
    def test_parser_accepts_companion_session_run_command(self) -> None:
        ...
        self.assertEqual(args.authority_wait_seconds, 30.0)
        self.assertEqual(args.broker_process_wait_seconds, 20.0)
        self.assertEqual(args.makepad_process_wait_seconds, 20.0)
        self.assertEqual(args.socket_wait_seconds, 20.0)
        self.assertEqual(args.launch_settle_seconds, 8.0)
        self.assertEqual(args.runtime_subscriber_retry_count, 8)
        self.assertEqual(args.runtime_subscriber_retry_wait_seconds, 2.0)
