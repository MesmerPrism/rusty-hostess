...
try {
    $PythonFiles = @(
        ...
        "tools\hostessctl\connectivity_probe_live_reports.py",
        ...
        "tools\test_hostessctl_companion_operator_actions.py",
        "tools\test_hostessctl_companion_readiness.py",
        "tools\test_hostessctl_companion_report_projection.py",
        "tools\test_hostessctl_companion_session.py",
        "tools\test_hostessctl_connectivity_probe.py",
        "tools\connectivity_probe_tests\__init__.py",
        "tools\connectivity_probe_tests\helpers.py",
        "tools\connectivity_probe_tests\fixture_reports.py",
        "tools\connectivity_probe_tests\media_receiver.py",
        "tools\connectivity_probe_tests\websocket_data_protocols.py",
        "tools\connectivity_probe_tests\live_transport.py",
        "tools\connectivity_probe_tests\facade_parser_firewall.py",
