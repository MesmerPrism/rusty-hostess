    ...
    def test_summarizes_proof_and_filters_vrapi_to_hostess_pid(self):
        proof_lines = [
            ...
            log_line(
                ...
                "observedResidentProofs=1 reusedResidentProofs=0 requiredResidentProofs=4 "
                "residencyContinuityReady=false residencyContinuityBroken=false "
                "residencyContinuityBreakCount=0 sourceMeshBufferGenerationMatched=true "
                "derivedBufferGenerationMatched=true queueSubmitSerialMonotonic=true "
                "fenceSerialMonotonic=true boundedProofOnly=true "
                ...
                "activeForceAuthorityChanged=false matterCpuFallbackReady=true "
                "sourceMeshBufferGeneration=1 sourceMeshBuffersResident=true "
                "sourceMeshBuffersReused=false derivedBufferGeneration=1 "
                "derivedBuffersResident=true derivedBuffersReused=false "
                "runtimeParticleIntegration=false forceAuthorityReady=false "
                "runtimeForceAuthority=false gpuComputeReady=false "
                "highRateJsonPayload=false settingsControlPayload=false",
            ...
            log_line(
                ...
                "candidateEligible=true candidateSelected=false candidatePromoted=false "
                "residencyTrackerSource=quest-makepad-gpu-force-authority-residency-tracker "
                "observedResidentProofs=2 reusedResidentProofs=1 requiredResidentProofs=4 "
                "residencyContinuityReady=true residencyContinuityBroken=false "
                "residencyContinuityBreakCount=0 sourceMeshBufferGenerationMatched=true "
                "derivedBufferGenerationMatched=true queueSubmitSerialMonotonic=true "
                "fenceSerialMonotonic=true boundedProofOnly=true "
                "steadyStateResidencyReady=false freshnessReady=false cadenceReady=false "
                ...
                "activeForceAuthorityChanged=false matterCpuFallbackReady=true "
                "sourceMeshBufferGeneration=1 sourceMeshBuffersResident=true "
                "sourceMeshBuffersReused=true derivedBufferGeneration=1 "
                "derivedBuffersResident=true derivedBuffersReused=true "
                "runtimeParticleIntegration=false forceAuthorityReady=false "
                "runtimeForceAuthority=false gpuComputeReady=false "
                "highRateJsonPayload=false settingsControlPayload=false",
